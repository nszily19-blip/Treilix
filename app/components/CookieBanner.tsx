      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="text-sm text-slate-700">
          ...
          <p className="mt-1 leading-6">
            We use essential cookies to keep Treilix working properly. With your
            consent, we also use analytics cookies to understand website usage
            and improve the platform. Read our{" "}
