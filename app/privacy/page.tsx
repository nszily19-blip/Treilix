      ...
      <div className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-10">
        ...
        <section className="mt-8">
          ...
          <div className="mt-3 space-y-3 text-sm leading-7 text-slate-700">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>Technical information such as browser type, device information, and request data</li>
              <li>Cookie preferences stored in your browser</li>
              <li>Website usage and analytics data where consent has been given</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mt-8">
          ...
          <div className="mt-3 space-y-3 text-sm leading-7 text-slate-700">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>Measure website performance and usage trends</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mt-8">
          ...
          <div className="mt-3 space-y-3 text-sm leading-7 text-slate-700">
            ...
            <p>
              Where required, non-essential cookies such as analytics cookies are
              only used after your consent. You can manage your cookie choices
              through the cookie banner and through your browser settings.
            </p>
          </div>
        </section>
        ...
        <section className="mt-8">
          ...
          <div className="mt-3 space-y-3 text-sm leading-7 text-slate-700">
            <p>
              Treilix uses Google Analytics, a web analytics service provided by
              Google, to better understand how visitors use the website and to
              improve our services.
            </p>
            <p>
              Google Analytics may collect information such as visited pages,
              approximate location, device and browser information, and interaction
              data. This information helps us analyze traffic and improve the
              platform.
            </p>
            <p>
              Google Analytics is only activated where required after the user has
              given consent through the cookie banner. You can also control cookies
        ...
        <section className="mt-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-700">
            ...
            maintain platform security, improve the platform, and fulfill legal
            obligations.
          </p>
        </section>
